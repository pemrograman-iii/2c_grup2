...
\item Jelaskan langkah-langkah membuat sumbu X dan Y di matplotlib\\
Jawab :
\lstinputlisting[firstline=2, lastline=11]{src/6/1174076/Teori/1174076.py}
...
\lstinputlisting[firstline=14, lastline=20]{src/6/1174076/Teori/1174076.py}
\item Bar
Grafik batang menggambarkan perbandingan antar beberapa item.
\lstinputlisting[firstline=21, lastline=28]{src/6/1174076/Teori/1174076.py}
\item Histogram
sebuah representasi grafik yang menampilkan impresi visual dari distribusi data
\lstinputlisting[firstline=29, lastline=35]{src/6/1174076/Teori/1174076.py}
\end{itemize}

\item Jelaskan bagaimana cara menggunakan legend dan label serta kaitannya dengan fungsi tersebut\\
Jawab :
\lstinputlisting[firstline=37, lastline=48]{src/6/1174076/Teori/1174076.py}

\item Jelaskan apa fungsi dari subplot di matplotlib, dan bagaimana cara kerja dari fungsi subplot, sertakan ilustrasi dan gambar sendiri dan apa parameternya jika ingin menggambar plot dengan 9 subplot di dalamnya\\
\lstinputlisting[firstline=50, lastline=74]{src/6/1174076/Teori/1174076.py}
...
\begin{enumerate}
	...
	\lstinputlisting[firstline=8, lastline=8]{src/6/1174079/Teori/1174079.py}
	
	\item Kemudian buat variable array dengan nama X, isi sesuai keinginan
	\lstinputlisting[firstline=9, lastline=9]{src/6/1174079/Teori/1174079.py}
	
	\item Kemudian buat variable array dengan nama X, isi sesuai keinginan dengan jumlah yang sama dengan variable array X
	\lstinputlisting[firstline=10, lastline=10]{src/6/1174079/Teori/1174079.py}
	
	\item Kemudian kita panggil function plot yang akan diisi variable X dan Y
	\lstinputlisting[firstline=11, lastline=11]{src/6/1174079/Teori/1174079.py}
	
	\item Terakhir, gunakan function show() untuk menampilkan apa yang telah kita buat
	\lstinputlisting[firstline=12, lastline=12]{src/6/1174079/Teori/1174079.py}
\end{enumerate}
...
\begin{itemize}
	...
	\lstinputlisting[firstline=8, lastline=12]{src/6/1174079/Teori/1174079.py}
	
	\item Bar
	
	Bar adalah sebuah grafik berbentuk batang (bar) dan berikut cara penggunaanya
	\lstinputlisting[firstline=15, lastline=19]{src/6/1174079/Teori/1174079.py}
	...
	\lstinputlisting[firstline=21, lastline=24]{src/6/1174079/Teori/1174079.py}
	...
	\lstinputlisting[firstline=26, lastline=38]{src/6/1174079/Teori/1174079.py}
	...
	\lstinputlisting[firstline=40, lastline=58]{src/6/1174079/Teori/1174079.py}
\end{itemize}
...
\lstinputlisting[firstline=53, lastline=58]{src/6/1174079/Teori/1174079.py}
...
\lstinputlisting[firstline=60, lastline=80]{src/6/1174079/Teori/1174079.py}
...
\lstinputlisting[firstline=82, lastline=87]{src/6/1174079/Teori/1174079.py}
