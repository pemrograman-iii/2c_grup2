...
langkah dibawah ini adalah langkah alternatif jika terjadi error, langkah ini akan menginstall driver arduino dari device manager
	...
	\item Klik next saja lalu pilih install
	\begin{figure}[ht!]
		\includegraphics[width=5cm]{figures/5/1174079/3a.png}
		\centering
		\caption{Install driver}
	\end{figure}
	\item Driver selesai terinstall 
	\begin{figure}[ht!]
		\includegraphics[width=5cm]{figures/5/1174079/2a.png}
		\centering
		\caption{Selesai}
	\end{figure}
	
	\item Cek hasil instalasi
	\begin{figure}[ht!]
		\includegraphics[width=5cm]{figures/5/1174079/1a.png}
		\centering
		\caption{Result}
	\end{figure}
	\end{itemize}
...
Baudrate (bits per second) adalah suatu takaran yang digunakan untuk mengukur informasi yang akan di sampaikan atau dikirim dan cara membacanya sendiri adalah dengan cara membuka aplikasi arduino IDEnya lalu mengklik icon serial monitor. 
Port sendiri bisa kita lihat di bagian device manager pada opsi port, tinggal dibuka saja dropdownnya maka akan tampil port number berapanya
...
\lstinputlisting[firstline=7, lastline=14]{src/5/1174079/Teori/1174079.py}
