# -*- coding: utf-8 -*-
"""
Created on Tue Mar 26 17:45:49 2019
...
with open('teori2.csv', mode='w') as csv_file:
    ...
    csv_writer.writerow(['1174023', 'Aulyta', 'D4TI2C'])
    csv_writer.writerow(['1174009', 'Aurawardha', 'D4TI2A'])
...
with open('teori3.csv', mode='w') as csv_file:
    ...
    writer.writeheader()
    writer.writerow({'npm': '1174014', 'nama': 'Audyardha', 'kelas': 'D4TI2C'})
    writer.writerow({'npm': '1174013', 'nama': 'Audylan', 'kelas': 'D4TI2C'})
